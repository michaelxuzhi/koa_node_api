...
- 注意事项：
  ...
  - 商品已经处于上架状态，即：`deleteAt`字段=NULL，重复上架会提示商品ID无效（报错信息是个人设置）

- 上架原理：

  - 将数据表中的记录的`deleteAt`字段的时间置为NULL

- 接口测试：

  - 处于下架状态的商品：
    ![image-20211219224913968](Readme.assets/image-20211219224913968.png)

  - 接口测试：
    ![image-20211219225008493](Readme.assets/image-20211219225008493.png)
  - 数据库中id=1的商品记录变化：
